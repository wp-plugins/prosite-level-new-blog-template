<?php
/*
Plugin Name: Prosite Level New Blog Template
...
function pmnbt_admin() {
    include('prosite-level-new-blog-template-admin.php');
}

function pmnbt_admin_actions() {
add_menu_page("Prosite Level New Blog Template", "Prosite Level New Blog Template", 1, "Prosite Level New Blog Template", "pmnbt_admin");
}
